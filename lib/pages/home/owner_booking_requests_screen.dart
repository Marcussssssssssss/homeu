...
class _HomeUOwnerBookingRequestsScreenState extends State<HomeUOwnerBookingRequestsScreen> {
  ...
  Widget _buildBookingRequestsTab() {
    return ListenableBuilder(
      ...
      builder: (context, child) {
        if (_bookingController.isLoading && _bookingController.requests.isEmpty) {
          return const Center(child: CircularProgressIndicator(color: Color(0xFF1E3A8A)));
        }
        if (_bookingController.errorMessage != null && _bookingController.requests.isEmpty) {
          return Center(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Icon(Icons.error_outline, color: Colors.red, size: 48),
                const SizedBox(height: 16),
                Text(_bookingController.errorMessage!, style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                TextButton(onPressed: _bookingController.loadRequests, child: const Text('Retry')),
              ],
            ),
          );
        }
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected = _bookingController.selectedFilter == filter;
  ...
  Widget _buildViewingRequestsTab() {
    return ListenableBuilder(
      ...
      builder: (context, child) {
        if (_viewingController.isLoading && _viewingController.requests.isEmpty) {
          return const Center(child: CircularProgressIndicator(color: Color(0xFF1E3A8A)));
        }

        final displayedRequests = _viewingController.filteredRequests;
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected = _viewingController.selectedFilter == filter;
              ...
              child: RefreshIndicator(
                ...
                child: displayedRequests.isEmpty
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final timeStr = "${request.scheduledAt.hour % 12 == 0 ? 12 : request.scheduledAt.hour % 12}:${request.scheduledAt.minute.toString().padLeft(2, '0')} ${request.scheduledAt.hour >= 12 ? 'PM' : 'AM'}";
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              const Icon(Icons.access_time_rounded, size: 16, color: Color(0xFF90A4C4)),
                              const SizedBox(width: 8),
                              Text(
                              ...
                              children: [
                                Expanded(
                                  child: OutlinedButton(
                                    onPressed: () => _viewingController.updateStatus(request.id, 'Rejected'),
                                ...
                                Expanded(
                                  child: ElevatedButton(
                                    onPressed: () => _viewingController.updateStatus(request.id, 'Approved'),
